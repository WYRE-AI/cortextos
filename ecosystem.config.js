  ...
  apps: [
    {
      ...
      script: "/Users/asachs/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/asachs/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/asachs/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/asachs/cortextos",
        CTX_PROJECT_ROOT: "/Users/asachs/cortextos",
        CTX_ORG: process.env.CTX_ORG || "wyre",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: "npm",
      args: "run dev",
      cwd: "/Users/asachs/cortextos/dashboard",
      env: {
