...
- **Always convert non-.md files before reading them off the SharePoint mount** (`onedrive/` symlink) — see `.claude/skills/sharepoint-docs/SKILL.md`
- Installed on: Mac fleet host (pipx, confirmed working 2026-07-22). wyre-os-dev (wh-harness angela/tyler) rollout in progress — check `.claude/skills/sharepoint-docs/SKILL.md` for current status if unsure
